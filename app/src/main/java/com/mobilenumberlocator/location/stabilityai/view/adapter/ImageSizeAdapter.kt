...
class ImageSizeAdapter @Inject constructor(
    private val context: Context
) :
    RecyclerView.Adapter<ImageSizeAdapter.ViewHolder>() {
    var dataList: ArrayList<ImageSizesModel> = arrayListOf()
    ...
    fun updateData(list: ArrayList<ImageSizesModel>) {
        dataList = list
